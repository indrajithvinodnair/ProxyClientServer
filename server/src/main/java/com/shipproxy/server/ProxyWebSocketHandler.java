                            ...
                            protected void handleTextMessage(WebSocketSession session, TextMessage message) {
                                executorService.submit(() -> {
                                    try {
                                        ...
                                        ResponseEntity<String> responseEntity = webClient.method(proxyRequest.getHttpMethod())
                                                .uri(proxyRequest.getUrl())
                                                .headers(headers -> headers.addAll(proxyRequest.getHeaders()))
                                                .bodyValue(body)
                                                .retrieve()
